...
export const tutorials = [
  {title: "Hover Button", description: "Create a stylish hover button with HTML and CSS", imageUrl: "/tutorials/hover-button.png", link: "/tutorials/hover-button", date: "2025", color: "#7fb086"},
