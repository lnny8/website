...
export default function HoverButton({text1, text2, className, disabled, loading}: {text1: string; text2: string; className?: string; disabled?: boolean; loading?: boolean}) {
  ...
  return (
    <div
      ...
      className={`relative flex items-center justify-center w-full overflow-hidden h-full cursor-pointer border border-white light:border-black px-4 py-2 rounded-full ${className}`}>
