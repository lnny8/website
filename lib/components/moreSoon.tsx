...
export default function MoreSoon() {
  return (
    <div className="max-w-7xl mx-auto grid md:grid-cols-2 content-center place-items-center rounded-3xl shadow-(--inset_shadow) bg-woodsmoke-light light:bg-athensgray-light">
