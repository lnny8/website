...
export default function MoreSoon() {
  return (
    <motion.div initial={{opacity: 0, scale: 0.8, y: 100}} whileInView={{opacity: 1, scale: 1, transition: {duration: 1, type: "spring", delay: 0.3}}} className="md:max-w-7xl mx-6 md:mx-auto grid md:grid-cols-2 content-center place-items-center rounded-3xl shadow-(--inset_shadow) bg-woodsmoke-light light:bg-athensgray-light">
