...
export default function Page() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      {/* Hero */}
      <section id="start" className="relative w-screen overflow-hidden h-screen mt-60 max-w-6xl mx-auto" aria-label="Hero section with a big ASCII Art of the name Lenny from the author Lenny Muffler">
        {/* <Suspense fallback={"loading..."}>
          <Name />
        </Suspense> */}
        <h1 className="text-2xl font-semibold max-w-2xl">Hi, I'm Lenny, a full stack developer crafting immersive web experiences and useful web applications.</h1>
        <button onClick={() => alert("test")} className="w-42 mt-10 relative">
          <HoverButton text1="Hover me" text2="Hover me 2" />
        </button>
      </section>
      ...
      <section id="knowledge" className="px-6 pb-24">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mt-6 text-3xl font-bold tracking-tight sm:text-5xl">My knowledge</h2>
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {Object.entries(skills).map(([category, skillList]) => (
              <article key={category} className="relative backdrop-blur-lg overflow-hidden rounded-3xl bg-white/5 border-1 border-white/10 p-6 transition-all duration-300 hover:border-white/20 hover:bg-white/10">
