...
export default function Footer() {
  return (
    <footer className="w-full bg-woodsmoke light:bg-athensgray light:text-black pt-40">
      <div className="rounded-4xl bg-[#111116] light:bg-white w-full max-w-7xl mx-auto py-20 flex flex-col items-center justify-center">
        ...
        <span className="text-5xl max-w-md font-clash font-medium tracking-wide text-center mt-5">Let's create your next big idea</span>
      ...
      <div className="flex items-center justify-between max-w-7xl mx-auto py-10">
        ...
        <div className="flex gap-4">
          ...
          <Link href="github.com/lnny8" target="_blank" aria-label="GitHub">
            <X className="size-5 text-white/70 light:text-black/70 hover:text-white transition-all duration-300" />
          </Link>
